...
link:console-differences.html["NetApp Console 로컬 배포와 NetApp Console SaaS 및 프라이빗 모드의 차이점을 알아보십시오."].
...
NetApp Console 로컬 배포는 자체 인프라에서 실행되므로 팀에서 배포, 연결 및 일상적인 운영을 제어할 수 있습니다. 이를 통해 기업 관리자는 운영 경계를 완벽하게 제어하면서 관리 데이터를 환경 내부에 유지할 수 있습니다.
