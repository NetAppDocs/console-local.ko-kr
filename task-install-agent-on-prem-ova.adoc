...
[NOTE]
====
* ESXi 호스트에서는 가상 머신이 시작될 때 CPU와 메모리가 할당되는 것이 아니라 예약됩니다. 대상 호스트에 최소 16개의 CPU 코어와 64GB의 예약 용량이 확보되어 있는지 확인하십시오. 호스트에 이미 예약된 가상 머신이 있는 경우 사용 가능한 용량이 줄어듭니다.
