...
summary: NetApp Backup and Recovery에 대한 액세스 권한을 사용자에게 부여하려면 Console에서 다음 역할을 할당할 수 있습니다. Backup and Recovery 역할을 사용하면 조직 내에서 사용자가 수행해야 하는 특정 작업에 맞는 역할을 유연하게 할당할 수 있습니다. 역할 할당 방법은 비즈니스 및 스토리지 관리 관행에 따라 달라집니다. 
---
...
모든 NetApp Console 액세스 역할에 대한 자세한 내용은 https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["콘솔 설정 및 관리 문서"^]을 참조하십시오.
...
| 자격 증명(호스트, 인스턴스, vCenter) 추가 | 예 | 아니요  a| 
아니요
 a| 
아니요
 a| 
