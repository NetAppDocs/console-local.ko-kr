...
* *ONTAP 알림*은 Console 로컬 배포에서 검색한 온프레미스 클러스터의 ONTAP 이벤트 관리 시스템(EMS)에서 발생합니다. link:https://docs.netapp.com/us-en/ontap-ems/acp-auto-events.html["ONTAP EMS 및 사용 가능한 알림에 대해 자세히 알아보십시오."^]
